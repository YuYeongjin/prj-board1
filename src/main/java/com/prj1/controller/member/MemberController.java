package com.prj1.controller.member;

import com.prj1.domain.member.MemberDto;
import com.prj1.service.member.MemberService;
...
public class MemberController {
    ...
    @ResponseBody
    public Map<String, Object> existNickName(@RequestParam Map<String,String> req){
